struct Recipe: Identifiable, Hashable {
    ...
    let ingredientGrams: [String: Double]
    let minutes: Int
    let diets: Set<Diet>
    let steps: [String]
...
extension Recipe {
    var attributes: RecipeAttributes {
        switch id {
        case "tomato-eggs": .init(effort: .minimal, tools: [.onePot], cuisine: .chinese, occasions: [.weekday, .kids], weather: [.hot], estimatedCostPerPerson: 12)
        case "fried-rice": .init(effort: .easy, tools: [.onePot], cuisine: .chinese, occasions: [.weekday, .lateNight, .lunchbox, .kids], weather: [.rainy], estimatedCostPerPerson: 10)
        case "chicken-potato": .init(effort: .involved, tools: [.onePot, .riceCooker], cuisine: .chinese, occasions: [.gathering, .lunchbox], weather: [.cold, .rainy], estimatedCostPerPerson: 24)
        case "tofu-mushroom": .init(effort: .easy, tools: [.onePot], cuisine: .chinese, occasions: [.weekday, .fitness], weather: [.hot], estimatedCostPerPerson: 16)
        case "beef-noodles": .init(effort: .easy, tools: [.onePot], cuisine: .chinese, occasions: [.weekday, .lateNight], weather: [.cold, .rainy], estimatedCostPerPerson: 28)
        case "shrimp-rice": .init(effort: .easy, tools: [.onePot, .riceCooker], cuisine: .chinese, occasions: [.fitness, .lunchbox], weather: [.hot], estimatedCostPerPerson: 26)
        default: .init(effort: .minimal, tools: [.noFire, .airFryer], cuisine: .western, occasions: [.weekday, .lateNight, .kids], weather: [.hot], estimatedCostPerPerson: 18)
        }
    }
}
...
enum RecipeCatalog {
    ...
    static let recipes: [Recipe] = [
        Recipe(id: "tomato-eggs", name: "番茄炒蛋", emoji: "🍅", ingredients: ["番茄", "鸡蛋"], ingredientGrams: ["番茄": 300, "鸡蛋": 150], minutes: 15, diets: [.vegetarian, .glutenFree], steps: ["番茄切块，鸡蛋打散。", "先炒鸡蛋盛出，再炒番茄。", "鸡蛋回锅调味即可。"]),
        Recipe(id: "fried-rice", name: "家常炒饭", emoji: "🍚", ingredients: ["米饭", "鸡蛋", "青菜", "洋葱"], ingredientGrams: ["米饭": 300, "鸡蛋": 100, "青菜": 100, "洋葱": 80], minutes: 18, diets: [.vegetarian, .dairyFree, .glutenFree], steps: ["食材切小块。", "鸡蛋炒散，加入蔬菜。", "加入米饭炒匀并调味。"]),
        Recipe(id: "chicken-potato", name: "土豆炖鸡", emoji: "🍲", ingredients: ["鸡肉", "土豆", "洋葱"], ingredientGrams: ["鸡肉": 300, "土豆": 400, "洋葱": 100], minutes: 40, diets: [.dairyFree, .glutenFree], steps: ["鸡肉煎至变色。", "加入土豆和洋葱翻炒。", "加水调味，炖至软烂。"]),
        Recipe(id: "tofu-mushroom", name: "蘑菇烧豆腐", emoji: "🍄", ingredients: ["豆腐", "蘑菇", "青菜"], ingredientGrams: ["豆腐": 300, "蘑菇": 200, "青菜": 150], minutes: 25, diets: [.vegetarian, .dairyFree, .glutenFree], steps: ["豆腐煎至两面金黄。", "加入蘑菇炒软。", "加入青菜和调味料收汁。"]),
        Recipe(id: "beef-noodles", name: "洋葱牛肉面", emoji: "🍜", ingredients: ["牛肉", "面条", "洋葱", "青菜"], ingredientGrams: ["牛肉": 250, "面条": 300, "洋葱": 100, "青菜": 100], minutes: 30, diets: [.dairyFree], steps: ["面条煮熟备用。", "牛肉与洋葱炒香。", "加入汤和青菜，与面条组合。"]),
        Recipe(id: "shrimp-rice", name: "鲜虾盖饭", emoji: "🍤", ingredients: ["虾", "米饭", "鸡蛋", "青菜"], ingredientGrams: ["虾": 250, "米饭": 300, "鸡蛋": 100, "青菜": 100], minutes: 25, diets: [.dairyFree, .glutenFree], steps: ["虾仁煎熟。", "鸡蛋和青菜炒熟。", "铺在米饭上并调味。"]),
        Recipe(id: "cheese-toast", name: "芝士蛋吐司", emoji: "🥪", ingredients: ["面包", "奶酪", "鸡蛋"], ingredientGrams: ["面包": 120, "奶酪": 60, "鸡蛋": 100], minutes: 10, diets: [.vegetarian], steps: ["面包放上奶酪。", "煎一颗鸡蛋。", "组合后烤至奶酪融化。"])
    ]
}
